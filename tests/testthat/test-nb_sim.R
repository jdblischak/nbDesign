test_that("nb_sim generates correct structure", {
  ...
  sim <- nb_sim(enroll_rate, fail_rate, dropout_rate, max_followup, n = 100)
...
test_that("nb_sim handles dropout", {
  ...
  sim <- nb_sim(enroll_rate, fail_rate, dropout_rate, max_followup, n = 50)
...
test_that("nb_sim respects n argument", {
  ...
  # Force n=50
  sim <- nb_sim(enroll_rate, fail_rate, max_followup = max_followup, n = 50)
